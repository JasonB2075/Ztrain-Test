...
test('Create account succefull', async ({ page,browser }) => {
  ...
  await page.locator(".MuiTabs-root button:nth-child(1)").click();
  
  //Remplir les champs du formulaire
  await page.locator("#email_login").fill(email);
  await page.locator("#password_login").fill("123456789");
